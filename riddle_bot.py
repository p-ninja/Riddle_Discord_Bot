    ...
    async def on_message(self, message: Message):
        ...
        if message.content.startswith("$"):
            ...
            if cmd == "stats":
                ...
                if not args:
                    await message.channel.send("usage: $delete <level-id>")
                    return
                else:
                ...
                async with message.channel.typing():
                    ...
                    for level in self.get_levels():
                        ...
                        await level_channel.edit(name=level_name(level - 1))
                        await solution_channel.edit(name=solution_name(level - 1))
                        await role.edit(name=role_name(level - 1))
